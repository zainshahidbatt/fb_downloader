package com.bluelock.fb.util.adapters;


import static com.bluelock.fb.util.Utils.appInstalledOrNot;
import static com.bluelock.fb.util.Utils.deleteVideoFromFile;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ListViewHolder holder, int position) {
        ...
        if (video.getState() == FVideo.COMPLETE) {
            ...
            holder.ivThumbnail.setImageResource(R.drawable.ic_back);
        }
