...
import com.bluelock.fb.adapter.MyAdapter
import com.bluelock.fb.databinding.ActivityDownloadedBinding
import com.bluelock.fb.interfaces.ItemClickListener
...
class DownloadedActivity : AppCompatActivity(), ItemClickListener {
    ...
    private suspend fun refreshFiles() {
        fileList.clear()
        Utils.RootDirectoryFacebookShow.listFiles()?.let { f ->
            f.forEach {
