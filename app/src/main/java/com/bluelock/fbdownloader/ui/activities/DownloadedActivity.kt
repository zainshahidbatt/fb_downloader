...
import com.bluelock.fbdownloader.adapter.MyAdapter
import com.bluelock.fbdownloader.databinding.ActivityDownloadedBinding
import com.bluelock.fbdownloader.interfaces.ItemClickListener
import com.bluelock.fbdownloader.remote.RemoteConfig
import com.bluelock.fbdownloader.util.Utils.RootDirectoryFacebookShow
...
class DownloadedActivity : AppCompatActivity(), ItemClickListener {
    ...
    private suspend fun refreshFiles() {
        fileList.clear()
        RootDirectoryFacebookShow.listFiles()?.let { f ->
            f.forEach {
