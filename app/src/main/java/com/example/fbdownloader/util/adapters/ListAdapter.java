package com.example.fbdownloader.util.adapters;


import static com.example.fbdownloader.util.Utils.appInstalledOrNot;
import static com.example.fbdownloader.util.Utils.deleteVideoFromFile;
